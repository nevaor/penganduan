...
<body>
    <header>
        {{-- kalau uda login. button yg dimunculkan  button buat masuk ke halaman data  --}}
        @if(Auth::check())
        ...
        @elseif (Auth::user()->role == 'petugas')
         ...
         @endif
        {{-- kalau dia belom login , button yg dimunculkan button buat ke halaman login --}}
        @else
    ...
    <section class="baris">
        ...
        <div class="kolom kolom2">
            <img src="{{asset('assets/image/layanan.png')}}" alt="">
        </div>
    </section>
    ...
    <section class="form-container">
        <div class="card form-card">
            ...
            @endif
            {{-- menampilkan notif berhasil di tambahkan  --}}
        ...
        <div class="card laporan-card">
            ...
            <div class="article">
                {{-- carbon : mengelola tanggal. parse untuk mengubah format --}}
        ...
        @endforeach
        {{-- memunculkann button pagination --}}
